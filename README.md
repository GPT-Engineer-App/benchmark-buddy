...
**Project**: benchmark-buddy 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: a simple well thoughtout tool to manage LLM app benchmarks 
...
```sh
git clone https://github.com/GPT-Engineer-App/benchmark-buddy.git
cd benchmark-buddy
npm i
